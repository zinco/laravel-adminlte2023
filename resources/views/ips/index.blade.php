...
@section('title', 'Ip´s cadastrados')

@section('content_header')
<h1 class="m-0 text-dark">Busca por ip´s </h1>
@stop
...
<section class="content">
        <div class="container-fluid">
            <h2 class="text-center display-4">Busca</h2>
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    <form action="simple-results.html">
                        <div class="input-group">
                            <input type="search" class="form-control form-control-lg" placeholder="Digite um ip">
